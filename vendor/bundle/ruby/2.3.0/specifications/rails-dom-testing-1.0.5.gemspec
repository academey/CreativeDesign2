...
Gem::Specification.new do |s|
  ...
  s.date = "2014-11-25"
  s.description = " Dom and Selector assertions for Rails applications ".freeze
  s.email = ["rafaelmfranca@gmail.com".freeze, "kaspth@gmail.com".freeze]
  s.homepage = "https://github.com/kaspth/rails-dom-testing".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.10".freeze
  s.summary = "This gem can compare doms and assert certain elements exists in doms using Nokogiri.".freeze
